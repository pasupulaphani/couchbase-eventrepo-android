...
public class AuthSyncActivity extends ActionBarActivity {
    ...
    private void createPushReplication() {
        ...
        try {
            ...
            // for auth to work
            // $ curl -i -X PUT http://127.0.0.1:4985/couchbaseevents/_user/appuser -d '{"admin_channels":["*"]}' -H "Content-Type:application/json"

            Authenticator authenticator = AuthenticatorFactory
                    .createBasicAuthenticator(CBLSingleton.AUTH_USERNAME, CBLSingleton.AUTH_PASSWORD);
    ...
    private void updateThread() {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                // Create the document
                Event event = new Event("AUTH1 Updating Event", "123 Elm St",
